...
public class AccountManageBean implements Serializable {
    ...
    private void updateAccountList() {
        accounts = accountLocal.ViewAll(); // Fetch updated account list from session bean
    }
    
    public String updateSelectedStatus(Account account) {
        accountLocal.updateSelectedStatus(account);
        updateAccountList();
        return "list?faces-redirect=true";
    }
    ...
    public String deleteSelectedAccounts() {
        accountLocal.deleteSelectedAccounts();
        updateAccountList();
